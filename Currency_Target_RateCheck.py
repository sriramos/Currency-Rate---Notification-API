...
def mainLoop():
    ...
    test = CurrencyComparator(tree, 'EURUSD', 1.38355, -1)
    ...
    while True:
        ...
        if (selection == 1):
            ...
            print("Chice schosen" + str(choiceAboveOrBelow))
            ...
            while True:
                ...
                if (timeComparer - i > checkRate):
                    ...
                    if (test.direction == -1):
                        print("Currency Taken as Input " + test.currency)
                        print("it is Above1 target rate " + str(test.targetRate))
                        print("current rate " + str(tree.getCurrentRate(test.currency)))
                    elif (test.direction == 1):
                        print("Currency Taken as Input " + test.currency)
                        print("it is below target rate " + str(test.targetRate))
